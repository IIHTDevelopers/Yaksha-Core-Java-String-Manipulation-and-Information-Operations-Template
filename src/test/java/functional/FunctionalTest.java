...
public class FunctionalTest {
	...
	// Provide the path to the StringManipulationInfoAssignment class file
	String filePath = "src/main/java/com/yaksha/assignment/StringManipulationInfoAssignment.java";
	...
	public void testStringMethods() throws Exception {
		...
		boolean result = autoGrader.testStringMethods(filePath);
